...
class DataController: NSObject {
    ...
    static func addPayee(name: String, email: String, initialBalance: Float) -> Void {
        ...
        let user = [Label.NameKey: name,
                    Label.EmailKey: email,
                    Label.BalanceKey: initialBalance] as [String : Any]
